...
![在这里插入图片描述](./golang/1.png){style="max-width:360px;width:100%;display:block;margin:0 auto"}
点击原始配置：
![在这里插入图片描述](./golang/2.png){style="max-width:360px;width:100%;display:block;margin:0 auto"}
将gopls mcp监听的地址写入：
![在这里插入图片描述](./golang/3.png){style="max-width:520px;width:100%;display:block;margin:0 auto"}
保存后即可看到可用的工具
![在这里插入图片描述](./golang/4.png){style="max-width:360px;width:100%;display:block;margin:0 auto"}
其他编辑器类似

- 然后就可以正常使用了
![在这里插入图片描述](./golang/5.png){style="max-width:360px;width:100%;display:block;margin:0 auto"}
