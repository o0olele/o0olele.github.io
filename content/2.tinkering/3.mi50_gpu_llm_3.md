...
description: MI50 显卡散热解决方案，介绍外置风扇安装、lm-sensors 与 fancontrol 配置、NCT6775 传感器驱动加载以及 PWM 风扇转速手动控制方法。
seo:
  title: 【瞎折腾】mi50显卡ubuntu运行大模型开坑(三)安装风扇并且控制转速
  description: MI50 显卡散热解决方案，介绍外置风扇安装、lm-sensors 与 fancontrol 配置、NCT6775 传感器驱动加载以及 PWM 风扇转速手动控制方法，有效降低 GPU 运行温度。
navigation: Tinkering
date: 2025-05-10 00:17:34
---
...
![在这里插入图片描述](./tinkering/15.webp)

- 这是装好的外壳
![在这里插入图片描述](./tinkering/16.webp)
- 将风扇接口连接到主板的cpu fan上
![在这里插入图片描述](./tinkering/17.webp)
## 确认传感器
- 安装`fancontrol`
	~~~shell
