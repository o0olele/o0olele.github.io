...
seo:
  title: 【llm/langchain】langchain入门-使用langchain构建一个拥有RAG能力的代码问答应用(DeepSeek API&本地bge-m3&命令行版本)
...
- 在魔塔以及huggingface上，选择`句子相似度(Sentence Similarity)`
  ![在这里插入图片描述](./llm/8.webp){style="max-width:360px;width:100%;display:block;margin:0 auto"}
  ![在这里插入图片描述](./llm/9.webp)
